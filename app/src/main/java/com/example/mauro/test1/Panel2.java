...
public class Panel2 extends FragmentActivity implements ActionBar.TabListener {

    String vuelo, area;
    private EditText e, e1, e2, e3, e5, e6;
    ...
    private static final String LOGIN_URL = "http://aero.esy.es/act_mantenimiento.php";
    private static final String DESACT_URL = "http://aero.esy.es/desact_mantenimiento.php";
    private static final String LOGIN_URL2 = "http://aero.esy.es/act_mantenimiento2.php";
    private static final String DESACT_URL2 = "http://aero.esy.es/desact_mantenimiento2.php";
    ...
    private void Opcion(int position) {
        ...
        switch (position) {
            case 0:
                Intent i2 = new Intent(this,Panel2.class);
                startActivity(i2);
                break;
            case 1:
                f = new Procesos2();
    ...
    public void GetThis2 (View view) {
        ...
        if(asunto.isEmpty() || descripcion.isEmpty()){
            Toast.makeText(Panel2.this, "Alguno de los dos campos esta vacio.", Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            try {
                ...
                Toast.makeText(Panel2.this, "No hay clientes instalados...", Toast.LENGTH_SHORT).show();
            }
        }
    }
    public void GetThis1 (View view) {
        ...
        {
            Toast.makeText(Panel2.this, "Las contraseñas nuevas no son iguales", Toast.LENGTH_LONG).show();
            e2.setText("");
            e3.setText("");
        }
    }
    public void onCheckBoxClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.carga_c:
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.carga_c);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.carga_c);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.carga_c_l);
                    if(z.isChecked())
                    {
            ...
            case R.id.carga_c_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.carga_c_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    CheckBox A = (CheckBox) findViewById(R.id.carga_c);
                                    CheckBox B = (CheckBox) findViewById(R.id.carga_c_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.tren_a:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.tren_a);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.tren_a);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.tren_a_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.tren_a);
            ...
            case R.id.tren_a_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.tren_a_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.tren_a);
                                    CheckBox B = (CheckBox) findViewById(R.id.tren_a_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.aleron:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.aleron);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.aleron);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.aleron_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.aleron);
            ...
            case R.id.aleron_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.aleron_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.aleron);
                                    CheckBox B = (CheckBox) findViewById(R.id.aleron_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.kits_e:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.kits_e);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.kits_e);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.kits_e_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.kits_e);
            ...
            case R.id.kits_e_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.kits_e_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.kits_e);
                                    CheckBox B = (CheckBox) findViewById(R.id.kits_e_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.mascaras_o:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.mascaras_o);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.mascaras_o);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.mascaras_o_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.mascaras_o);
            ...
            case R.id.mascaras_o_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.mascaras_o_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.mascaras_o);
                                    CheckBox B = (CheckBox) findViewById(R.id.mascaras_o_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
    ...
    public class act_proc_l extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Panel2.this);
        ...
        protected void onPostExecute(String message) {
            pDialog.dismiss();
            if (message != null) {
                Toast.makeText(Panel2.this, message, Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public class cargar_comida extends AsyncTask<String,String, String>{
        ...
        protected void onPostExecute(String message) {
            ...
            {
                pDialog.dismiss();
                Toast.makeText(Panel2.this, "El telefono no posee conexión a internet", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public class cargar_lista extends AsyncTask<String,String, String>{
        ...
        protected void onPostExecute(String message) {
            if (message != null) {
                CheckBox c = (CheckBox) findViewById(R.id.carga_c);
                CheckBox c1 = (CheckBox) findViewById(R.id.carga_c_l);
                CheckBox c2 = (CheckBox) findViewById(R.id.tren_a);
                CheckBox c3 = (CheckBox) findViewById(R.id.tren_a_l);
                CheckBox c4 = (CheckBox) findViewById(R.id.aleron);
                CheckBox c5 = (CheckBox) findViewById(R.id.aleron_l);
                CheckBox c6 = (CheckBox) findViewById(R.id.kits_e);
                CheckBox c7 = (CheckBox) findViewById(R.id.kits_e_l);
                CheckBox c8 = (CheckBox) findViewById(R.id.mascaras_o);
                CheckBox c9 = (CheckBox) findViewById(R.id.mascaras_o_l);
                pDialog.dismiss();
                if(mant.equals("1")) {
                    c.setChecked(true);
                }
            ...
            if (message != null) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ListAdapter adapter = new SimpleAdapter(Panel2.this,
                                Lista,
