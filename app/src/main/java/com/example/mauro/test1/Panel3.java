...
public class Panel3 extends FragmentActivity implements ActionBar.TabListener {
    String vuelo, area;
    ...
    private static final String LOGIN_URL = "http://aero.esy.es/act_acomodadores.php";
    private static final String DESACT_URL = "http://aero.esy.es/desact_acomodadores.php";
    private static final String LOGIN_URL2 = "http://aero.esy.es/act_acomodador2.php";
    private static final String DESACT_URL2 = "http://aero.esy.es/desact_acomodadores2.php";
    ...
    public void GetThis2 (View view) {
        ...
        if(asunto.isEmpty() || descripcion.isEmpty()){
            Toast.makeText(Panel3.this, "Alguno de los dos campos esta vacio.", Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            try {
                ...
                Toast.makeText(Panel3.this, "No hay clientes instalados...", Toast.LENGTH_SHORT).show();
            }
        }
    }
    public void GetThis1 (View view) {
        ...
        {
            Toast.makeText(Panel3.this, "Las contrase�as nuevas no son iguales", Toast.LENGTH_LONG).show();
            e2.setText("");
            e3.setText("");
        }
    }
    public void onCheckBoxClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.verif_asientos:
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.verif_asientos);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.verif_asientos);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.verif_asientos_l);
                    if(z.isChecked())
                    {
            ...
            case R.id.verif_asientos_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.verif_asientos_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    CheckBox A = (CheckBox) findViewById(R.id.verif_asientos);
                                    CheckBox B = (CheckBox) findViewById(R.id.verif_asientos_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.recep_bol:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.recep_bol);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.recep_bol);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.recep_bol_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.recep_bol);
            ...
            case R.id.recep_bol_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.recep_bol_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.recep_bol);
                                    CheckBox B = (CheckBox) findViewById(R.id.recep_bol_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.e_class:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.e_class);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.e_class);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.e_class_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.e_class);
            ...
            case R.id.e_class_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.e_class_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.e_class);
                                    CheckBox B = (CheckBox) findViewById(R.id.e_class_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
            ...
            case R.id.p_class:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    proc = getResources().getString(R.string.p_class);
                                    new act_proc().execute();
                                }
                            })
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.p_class);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                ...
                {
                    CheckBox z = (CheckBox) findViewById(R.id.p_class_l);
                    if(z.isChecked())
                    {
                        Toast.makeText(this,"No se puede desmarcar un proceso que esta finalizado",Toast.LENGTH_SHORT).show();
                        CheckBox A = (CheckBox) findViewById(R.id.p_class);
            ...
            case R.id.p_class_l:
                if (checked) {
                    new AlertDialog.Builder(this)
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    CheckBox A = (CheckBox)findViewById(R.id.p_class_l);
                                    A.setChecked(false);
                                }
                            })
                            .show();
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    new desact_proc_l().execute();
                                    CheckBox A = (CheckBox) findViewById(R.id.p_class);
                                    CheckBox B = (CheckBox) findViewById(R.id.p_class_l);
                                    A.setChecked(false);
                                    B.setChecked(false);
                                }
                            })
    ...
    public class act_proc_l extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Panel3.this);
        ...
        protected void onPostExecute(String message) {
            pDialog.dismiss();
            if (message != null) {
                Toast.makeText(Panel3.this, message, Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public class cargar_comida extends AsyncTask<String,String, String>{
        ...
        protected void onPostExecute(String message) {
            ...
            {
                pDialog.dismiss();
                Toast.makeText(Panel3.this, "El telefono no posee conexión a internet", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public class cargar_lista extends AsyncTask<String,String, String>{
        ...
        protected void onPostExecute(String message) {
            CheckBox c = (CheckBox) findViewById(R.id.verif_asientos);
            CheckBox c1 = (CheckBox) findViewById(R.id.verif_asientos_l);
            CheckBox c2 = (CheckBox) findViewById(R.id.recep_bol);
            CheckBox c3 = (CheckBox) findViewById(R.id.recep_bol_l);
            CheckBox c4 = (CheckBox) findViewById(R.id.e_class);
            CheckBox c5 = (CheckBox) findViewById(R.id.e_class_l);
            CheckBox c6 = (CheckBox) findViewById(R.id.p_class);
            CheckBox c7 = (CheckBox) findViewById(R.id.p_class_l);
            pDialog.dismiss();
            if(acom.equals("1")) {
                c.setChecked(true);
            }
            ...
            if (message != null) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ListAdapter adapter = new SimpleAdapter(Panel3.this,
                                Lista,
